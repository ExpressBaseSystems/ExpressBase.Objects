...
.Replace("@maxheight@", this.MaxHeight > 0 ? this.MaxHeight.ToString() : "200");
        ...
        public override string EnableJSfn { get { return @"this.IsDisable = false; $('#cont_' + this.EbSid_CtxId + ' *').prop('disabled',false).find('[ui-inp]').css('background-color', '#fff'); $('#cont_' + this.EbSid_CtxId).find('.dpctrl-options-cont').show();"; } set { } }

        public override string DisableJSfn { get { return @"this.IsDisable = true; $('#cont_' + this.EbSid_CtxId + ' *').attr('disabled', 'disabled').find('[ui-inp]').css('background-color', '#f3f3f3'); $('#cont_' + this.EbSid_CtxId).find('.dpctrl-options-cont').hide()"; } set { } }
