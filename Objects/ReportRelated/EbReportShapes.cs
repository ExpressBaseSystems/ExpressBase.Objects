...
namespace ExpressBase.Objects.ReportRelated
{
    ...
    public class EbArrU : EbReportFieldShape
    {
        public override string GetDesignHtml()
        {
            return "<div class='arrow arrow-u-draggable dropped' eb-type='ArrU' id='@id' style='border: 1px solid black; width: @Width px; height: @Height px; 50px; position: relative; left: @Left px; top: @Top px;'><div class='arrow-up'></div></div>".RemoveCR().DoubleQuoted();
        }
        public override string GetJsInitFunc()
        {
            return @"
