...
namespace ExpressBase.Objects
{
    ...
    public class EbWebForm : EbForm
    {
        ...
        {
            if (this.AutoDeployTV)
                if (RefidMap.ContainsKey(this.AutoGeneratedVizRefId))
                    this.AutoGeneratedVizRefId = RefidMap[AutoGeneratedVizRefId];
    ...
    public static class EbFormHelper
    {
        public static List<string> DiscoverRelatedRefids(EbControlContainer _this)
        {
            ...
            for (int i = 0; i < _this.Controls.Count; i++)
            {
                ...
                {
                    refids.Add(_this.Controls[i].RefId );
                }
                else
                {
